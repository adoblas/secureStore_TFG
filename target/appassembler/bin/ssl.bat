...
%JAVACMD% %JAVA_OPTS% -DbootServer="true" -Xrunjdwp:transport=dt_socket,server=y,suspend=y,address=5005 -Xdebug -classpath %CLASSPATH% -Dapp.name="ssl" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" adoblas.ssl.Application %CMD_LINE_ARGS%
